...
class Ray:
    ...
    def cast(self, wall):
        ...
        if 0 < t < 1 and u > 0:
            ...
            if ray_x1 != wall_x1 and ray_x1 != wall_x2:
                # incidence angle
                a = array([wall_x2, wall_y2])  # punto en la pared
                b = intersection_point  # punto de interseccion
                c = array([ray_x1, ray_y1])  # es donde se encuentra el sonar

                # Banderas para saber la direccion del rayo
